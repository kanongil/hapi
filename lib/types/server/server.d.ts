...
export class Server<A = ServerApplicationState> {
    ...
    /**
     * Registers a custom content decoding compressor engine to extend the built-in support where:
    ...
    /**
     * Registers a custom content encoding compressor engine to extend the built-in support where:
