...
exports = module.exports = internals.Compression = class {
    ...
    constructor(options) {
        ...
        for (const [method, [compressor, decompressor]] of Object.entries(internals.builtin)) {
            this.encoders[method] = compressor.bind(null);
            this.decoders[method] = decompressor.bind(null);
